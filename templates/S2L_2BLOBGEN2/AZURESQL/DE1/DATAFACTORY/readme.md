...
-------------- | ------------------------
genericdataset | A Data Factory dataset that points to the source Azure SQL database. It does not need to point to the table as a select statement will be passed through.
